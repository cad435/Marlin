...
#define STRING_CONFIG_H_AUTHOR "cad435 for MicroBot" // Who made the changes.
...
#define HOTEND_OFFSET_Z {0.0, 5.00}  // (mm) relative Z-offset for each nozzle
 ...
 */
 #define DEFAULT_AXIS_STEPS_PER_UNIT   { 201, 201, 4000, 330} //Getunte config
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 220, 250, 2.5, 40 }
