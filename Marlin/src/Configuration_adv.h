...
#define DUAL_X_CARRIAGE
  ...
  #define X2_MIN_POS 30     // set minimum to ensure second x-carriage doesn't hit the parked first X-carriage
  #define X2_MAX_POS 235.5    // set maximum to the distance between toolheads when both heads are homed
  ...
  #define TOOLCHANGE_PARK_ZLIFT   1.5      // the distance to raise Z axis when parking an extruder
  #define TOOLCHANGE_UNPARK_ZLIFT 1.5        // the distance to raise Z axis when unparking an extruder
...
#define HOMING_BUMP_DIVISOR { 6, 4, 4 }  // Re-Bump Speed Divisor (Divides the Homing Feedrate)
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE {50*60, 50*60, 20*60, 60*25} // Feedrates for manual moves along X, Y, Z, E from panel
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_RETRACT_FEEDRATE         500  // (mm/s) Initial retract feedrate.
